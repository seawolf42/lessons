...
1. [Course Overview and Preparation](../README.md)
...
1. [Working with Real Projects](./projects_with_code.md)
    1. [Setting up Python Environments](./setup_python.md)
    1. [Setting up Data Science Environments](./setup_data_science.md)
